...
Measure overall hospital performance using key KPIs.

Identify the medical conditions driving treatment costs.

Compare hospital resource utilization across conditions.

Examine readmission patterns.

Compare patient experience between readmitted and non-readmitted patients.

Understand how cost, readmission, length of stay, and satisfaction vary across age groups.

Identify patients with both high treatment costs and low satisfaction.
